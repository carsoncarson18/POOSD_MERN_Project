...
export default function LeaveNeighborhoodPopup({setError,hood,setHoodLeaving,onLeaveHood}:{setError:Function,hood:Hood,setHoodLeaving:Function,onLeaveHood:Function}){
            ...
            <div className={styles.leaveHoodPopupContainer}>
                <div className={styles.leaveHoodPopup}>
                    <div style={{display:'flex',flexDirection:'column',gap:20,margin:'0 0 30px',width:'100%',alignItems:'center'}}>
                        {hood?<><button style={{margin:'10px 10px 0px auto'}} onClick={()=>{setHoodLeaving(undefined);setError("")}}>Exit</button>
